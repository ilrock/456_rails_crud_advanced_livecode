...
class GardensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garden" do
    assert_difference('Garden.count') do
      post gardens_url, params: { garden: { address: @garden.address, name: @garden.name, type: @garden.type } }
    end
  ...
  test "should update garden" do
    patch garden_url(@garden), params: { garden: { address: @garden.address, name: @garden.name, type: @garden.type } }
